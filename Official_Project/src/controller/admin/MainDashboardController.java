...
public class MainDashboardController implements Initializable {
    ...
    public void btnMediasOnClick(ActionEvent actionEvent) {
        FXMLLoader fxmlLoader = loadFxmlPage("/view/admin/pages/medias/medias.fxml");
        MediasController controller = fxmlLoader.getController();
     ...
     * @since                   1.0.0
     */
    public void btnCustomersOnClick() {
