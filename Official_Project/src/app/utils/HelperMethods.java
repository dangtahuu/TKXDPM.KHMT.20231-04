...
//        $                 # end-of-string
    ...
    /**
     * This method is used to validate a string if it is an valid media quantity.
     * {@link}              https://stackoverflow.com/a/15801999
     * @param integer       Accepts a string to validate as media quantity.
     * @return boolean      Returns true or false.
     * @since               1.0.0
     */
    public static boolean validateMediaQuantity(String integer){
     ...
     * @param mediaPrice  Accepts a string to validate as double.
     * @return boolean      Returns true or false.
     * @since               1.0.0
     */
    public static boolean validateMediaPrice(String mediaPrice){
        return mediaPrice.matches("^[0-9]+(|\\.)[0-9]+$");
    }
